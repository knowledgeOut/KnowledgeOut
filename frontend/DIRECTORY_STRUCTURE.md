...
### 질문 관련
- `GET /questions` → `features/question/api.js` → `/questions` 페이지
...
- `POST /questions/{id}/likes` → `features/question/api.js` 또는 `/api/questions/[id]/likes` API 라우트

### 답변 관련
- `POST /questions/{id}/answers` → `features/answer/api.js` 또는 `/api/questions/[id]/answers` API 라우트
- `PUT /questions/{id}/answers` → `features/answer/api.js` → `/questions/[id]/answers/[answerId]/edit` 페이지
- `DELETE /questions/{id}/answers` → `features/answer/api.js` 또는 `/api/questions/[id]/answers` API 라우트
- `POST /answers/{id}/likes` → `features/answer/api.js` 또는 `/api/answers/[id]/likes` API 라우트
